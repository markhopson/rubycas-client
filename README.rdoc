<b>Please Note</b>: If you plan to use <b>Flipp SSO</b>, then consider using {github.com/wishabi/flipp-rack-cas}[https://github.com/wishabi/flipp-rack-cas] instead; it is on {Artifactory}[https://flipplib.jfrog.io/flipplib/webapp/#/artifacts/browse/tree/General/flipp-gems-local/gems/flipp-rack-cas-1.0.0.gem], and comes bundled with the Flipp UserPermissions helper, so your project will not need the admin-shared.git submodule (yay).
